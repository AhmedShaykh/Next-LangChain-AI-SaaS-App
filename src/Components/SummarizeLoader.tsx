...
const SummarizeLoader = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="animate-spin w-10 h-10 border-t-4 border-b-4 border-orange-400 rounded-full" />
            ...
            <div className="text-2xl">
                ...
                {counter > 8 && (
                    <p className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent">
                        Final Touches for a Stellar Result
                    </p>
                )}
            </div>
        </div>
...
export default SummarizeLoader;