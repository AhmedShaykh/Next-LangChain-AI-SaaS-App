    ...
    try {
        ...
        if (userCoins === null || (userCoins?.coins && userCoins.coins < 10)) {
            ...
            return NextResponse.json({
                message: "You don't have sufficient coins for summary.Please add your coins.", status: 400
            });
        ...
        try {
            ...
            return NextResponse.json({
                message: "No Transcript available for this video.Plese try another video",
                status: 404
            });
